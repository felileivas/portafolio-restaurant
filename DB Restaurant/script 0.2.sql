...
INSERT INTO "RESTAURANT"."RESERVA" (ID_RESERVA, FECHA) VALUES ('1', TO_DATE('2020-10-03 00:00:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO "RESTAURANT"."MESA" (ID_MESA, CAPACIDAD, SECTOR, ESTADO, RESERVA_ID_RESERVA) VALUES ('1', '4', 'terraza', '1', '1');

INSERT INTO "RESTAURANT"."USUARIO" (ID_USUARIO, NOMBRE, CORREO, CONTRASENNA, RESERVA_ID_RESERVA) VALUES ('1', 'Felipe Leiva', 'felipe@cliente.cl', 'root', '1');

INSERT INTO "RESTAURANT"."RECETA" (ID_RECETA, NOMBRE, COSTO, ESTADO) VALUES ('1', 'Hamburgesa', '5000', '1');

INSERT INTO "RESTAURANT"."MESERO" (ID_MESERO, NOMBRE, CORREO, CONTRASENNA) VALUES ('1', 'Juan Pablo', 'jp@mesero.cl', 'toor');

INSERT INTO "RESTAURANT"."INSUMO" (ID_INSUMO, TIPO, CANTIDAD, RECETA_ID_RECETA) VALUES ('1', 'pan', '10', '1');

INSERT INTO "RESTAURANT"."INSUMO" (ID_INSUMO, TIPO, CANTIDAD, RECETA_ID_RECETA) VALUES ('2', 'hamburgesa carne', '10', '1');

INSERT INTO "RESTAURANT"."INSUMO" (ID_INSUMO, TIPO, CANTIDAD, RECETA_ID_RECETA) VALUES ('3', 'pepinillos', '10', '1');

INSERT INTO "RESTAURANT"."PEDIDO" (ID_PEDIDO, FECHA, COMENTARIO, USUARIO_ID_USUARIO, MESERO_ID_MESERO, RECETA_ID_RECETA) VALUES ('1', TO_DATE('2020-10-03 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'sin pepinillos', '1', '1', '1');

INSERT INTO "RESTAURANT"."MEDIOPAGO" (ID_MEDIOPAGO, NOMBRE, ESTADO) VALUES ('1', 'Efectivo', '1');
INSERT INTO "RESTAURANT"."MEDIOPAGO" (ID_MEDIOPAGO, NOMBRE, ESTADO) VALUES ('2', 'Tarjeta debito', '1');
INSERT INTO "RESTAURANT"."MEDIOPAGO" (ID_MEDIOPAGO, NOMBRE, ESTADO) VALUES ('3', 'Tarjeta Credito', '1');

INSERT INTO "RESTAURANT"."BOLETA" (ID_BOLETA, FECHA, MONTOTOTAL, MEDIOPAGO_ID_MEDIOPAGO, PEDIDO_ID_PEDIDO) VALUES ('1', TO_DATE('2020-10-03 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), '5000', '2', '1');
