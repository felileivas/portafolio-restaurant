...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Menuiteminsumo',
            fields=[
                ('id_menuitem', models.OneToOneField(db_column='id_menuitem', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='core.menuitem', verbose_name='Nombre de la preparacion de la receta')),
                ('cantidad', models.FloatField()),
                ('comentario', models.CharField(blank=True, max_length=50, null=True)),
            ],
            options={
